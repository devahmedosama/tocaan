	...
	<div class="page-header">
        ...
        <div class="header-sub-title">
            <nav class="breadcrumb breadcrumb-dash">
                ...
                <span class="breadcrumb-item active">{{ trans('home.Stocks') }}</span>
            </nav>
        </div>
    </div>
	<div class="card">
		<div class="card-body">
			<a href="{{ URL::to('admin/stocks/add') }}" class="btn btn-md btn-primary pull-right">{{ trans('home.Add Stock') }}</a>
			...
			<div class="table-responsive">
			    <table class="table">
			        ...
			        <tbody>
			            ...
			            <tr>
			                <td>{{ $data->name }}</td>
			                <td>{{ $data->stock_type->name }}</td>
			                <td>{{ $data->available_amount }} {{ $data->unit->name }}</td>
			                <td>{{ date('Y-m-d',strtotime($data->created_at)) }}</td>
			                <td>
			                	<a href="{{ URL::to('admin/stocks/edit/'.$data->id) }}" class="btn btn-primary btn-xs">
								  ...
								  <div class="modal-dialog" role="document">
								    <div class="modal-content">
								      ...
								      <div class="modal-footer">
								        ...
								        <a href="{{ URL::to('admin/stocks/delete/'.$data->id) }}" class="btn btn-danger">{{ trans('home.Confirm') }} </a>
								      </div>
								    </div>
								  </div>
								</div>
