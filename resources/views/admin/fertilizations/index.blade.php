	...
	<div class="card">
		<div class="card-body">
			<div class="panel-heading text-right">
		        {{ Form::open(['url'=>'admin/fertilization','method'=>'get','class'=>'search-form']) }}
		        <div class="row">
		            <div class="col-sm-5">
			    ...
			    <table class="table">
			        ...
			        <tbody>
			            ...
			            <tr>
			                ...
			                <td>{{ $data->date }}</td>
			                <td>
			                	<a href="{{ URL::to('admin/fertilization/edit/'.$data->id) }}" class="btn btn-primary btn-xs">
								  ...
								  <div class="modal-dialog" role="document">
								    <div class="modal-content">
								      ...
								      <div class="modal-footer">
								        ...
								        <a href="{{ URL::to('admin/fertilization/delete/'.$data->id) }}" class="btn btn-danger">{{ trans('home.Confirm') }} </a>
								      </div>
								    </div>
								  </div>
								</div>
