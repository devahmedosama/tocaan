...
@section('content')
	<div class="page-header">
        ...
        <div class="header-sub-title">
            <nav class="breadcrumb breadcrumb-dash">
                ...
                <a class="breadcrumb-item" href="{{ URL::to('admin/medicine?nursery_id='.app('request')->input('nursery_id')) }}">{{  trans('home.Medicines')  }}</a>
	...
	<div class="card">
		<div class="card-body">
			{{ Form::open(['url'=>'admin/medicine/add','files'=>true,'enctype'=>'multipart']) }}
			    ...
			    <div class="form-row">
			        ...
			        <div class="form-group col-md-6">
			            <label for="inputEmail4"> {{trans('home.Medicine') }} </label>
			            {{ Form::select('stock_id',$stocks,null,['class'=>'form-control basic-select','placeholder'=>trans('home.Choose Medicine'),'required']) }}
			        </div>
			        <div class="form-group col-md-6">
