...
@section('content')
	<div class="page-header">
        ...
        <div class="header-sub-title">
            <nav class="breadcrumb breadcrumb-dash">
                ...
                <a class="breadcrumb-item" href="{{ URL::to('admin/medicine?nursery_id='.$data->nursery_id) }}">{{ trans('home.Medicine') }}</a>
	...
	<div class="card">
		<div class="card-body">
			{{ Form::open(['url'=>'admin/medicine/edit/'.$data->id,'files'=>true,'enctype'=>'multipart']) }}
			    <div class="row">
