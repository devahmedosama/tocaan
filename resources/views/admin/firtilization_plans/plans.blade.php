			...
			<div class="panel-heading">
				<ul class="area-ul">
					@foreach($areas  as $area)
						<li> <a href="{{ URL::to('admin/fertilization-plans?area_id='.$area->id) }}"
						 class="btn  {{ (app('request')->input('area_id') ==  $area->id )?'btn-success':'btn-primary' }}">
							{{ $area->name }}</a> 
						</li>
			        @endforeach
				</ul>
					...
					<tbody>
						...
						<tr class="{{ ($state == 1)?'current_row':'' }}">
							...
							<td>
								...
								{{ ($data->state == 0)?trans('home.Not Yet'):trans('home.Done') }}
							...
							<td>
							     ...
							     <a href="{{ URL::to('admin/fertilization-plans/edit/'.$data->id) }}" class="btn btn-primary btn-xs">
								  ...
								  <div class="modal-dialog" role="document">
								    ...
								    <div class="modal-content">
								      ...
								      <div class="modal-footer">
								        ...
								        <a href="{{ URL::to('admin/fertilization-plans/delete/'.$data->id) }}" class="btn btn-danger">{{ trans('home.Confirm') }} </a>
