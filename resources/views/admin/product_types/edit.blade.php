...
@section('content')
	<div class="page-header">
        ...
        <div class="header-sub-title">
            <nav class="breadcrumb breadcrumb-dash">
                ...
                <a class="breadcrumb-item" href="{{ URL::to('admin/product-types') }}">{{ trans('home.Product Types') }}</a>
	...
	<div class="card">
		<div class="card-body">
			{{ Form::open(['url'=>'admin/product-types/edit/'.$data->id,'files'=>true,'enctype'=>'multipart']) }}
			   
			    <div class="form-row">
			    	<div class="form-group col-md-6">
			            <label for="inputEmail4"> {{trans('home.Product') }} </label>
			            {{ Form::select('product_id',$items,$data->product_id,['class'=>'form-control basic-select','placeholder'=>trans('home.Choose Product'),'required']) }}
			        </div>
