...
@section('content')
	...
	<div class="card">
		<div class="card-body">
			<a href="{{ URL::to('admin/product-types/add?product_id='.app('request')->input('product_id')) }}" class="btn btn-md btn-primary pull-right">{{ trans('home.Add New') }}</a>
			    ...
			    <table class="table">
			        ...
			        <tbody>
			            ...
			            <tr>
			                <td>{{ $data->name }}</td>
			                <td>
			                	<a href="{{ URL::to('admin/product-types/edit/'.$data->id) }}" class="btn btn-primary btn-xs">
								  ...
								  <div class="modal-dialog" role="document">
								    <div class="modal-content">
								      ...
								      <div class="modal-footer">
								        ...
								        <a href="{{ URL::to('admin/product-types/delete/'.$data->id) }}" class="btn btn-danger">{{ trans('home.Confirm') }} </a>
								      </div>
								    </div>
								  </div>
								</div>
