...
@section('content')
	...
	<div class="card">
		<div class="card-body">
			<a href="{{ URL::to('admin/farms/add') }}" class="btn btn-md btn-primary pull-right">{{ trans('home.Add Farming Area') }}</a>
			        ...
			        <tbody>
			            ...
			            <tr>
			                ...
			                <td>
			                	...
			                	<a href="{{ URL::to('admin/farms/edit/'.$data->id) }}" class="btn btn-primary btn-xs">
								  ...
								  <div class="modal-dialog" role="document">
								    <div class="modal-content">
								      ...
								      <div class="modal-footer">
								        ...
								        <a href="{{ URL::to('admin/farms/delete/'.$data->id) }}" class="btn btn-danger">{{ trans('home.Confirm') }} </a>
								      </div>
								    </div>
								  </div>
								</div>
