...
@section('content')
	<div class="page-header">
        ...
        <div class="header-sub-title">
            <nav class="breadcrumb breadcrumb-dash">
                ...
                <a class="breadcrumb-item" href="{{ URL::to('admin/fertilization-types?type='.$data->type) }}">{{ $parent_title }}</a>
	...
	<div class="card">
		<div class="card-body">
			{{ Form::open(['url'=>'admin/fertilization-types/edit/'.$data->id,'files'=>true,'enctype'=>'multipart']) }}
			   
			    <div class="form-row">
				   <div class="form-group col-md-12">
			            <label for="inputEmail4"> {{trans('home.Unit') }} </label>
			            {{ Form::select('unit_id',$units,$data->unit_id,['class'=>'form-control basic-select','required']) }}
			        </div>
