...
@section('content')
	...
	<div class="card">
		<div class="card-body">
			<a href="{{ URL::to('admin/stock-items/add?id='.app('request')->input('id')) }}" class="btn btn-md btn-primary pull-right">{{ trans('home.Add New') }}</a>
			    ...
			    <table class="table">
			        ...
			        <tbody>
			            ...
			            <tr>
			                <td>{{ $data->name }}</td>
			                <td>
			                	<a href="{{ URL::to('admin/stock-items/edit/'.$data->id) }}" class="btn btn-primary btn-xs">
								  ...
								  <div class="modal-dialog" role="document">
								    <div class="modal-content">
								      ...
								      <div class="modal-footer">
								        ...
								        <a href="{{ URL::to('admin/stock-items/delete/'.$data->id) }}" class="btn btn-danger">{{ trans('home.Confirm') }} </a>
								      </div>
								    </div>
								  </div>
								</div>
